...
const Footer = () => {
  return (
    <footer className="text-gray-700 px-4 md:px-10 lg:px-[9rem] py-10 bg-gray-100 border-t border-gray-300">
      <div className="flex flex-col lg:flex-row gap-10 justify-between">
        <div className="lg:w-[40%] md:w-[100%] sm:w-[100%] w-full">
          ...
          <p className="mb-1 text-gray-600">Send Us an Email:</p>
          <Link
          ...
          <div className="space-y-2 text-lg mt-2">
            <div className="flex items-center flex-wrap">
              ...
              <span className="text-gray-400 font-medium">+91 95376 74727</span>
            </div>
            <div className="flex items-center flex-wrap">
              ...
              : <FaPhoneAlt className="inline mx-2" />
              <FaWhatsapp className="inline mx-2" />
              <span className="text-gray-400 font-medium">+91 83476 74727</span>
            </div>
          </div>
          ...
          <div className="lg:w-1/3 md:w-1/2 sm:w-full w-full flex flex-col">
            ...
            <ul className="ml-2">
              <li className="my-2.5">
                <Link
                  to="/"
                  className="relative group text-gray-700 hover:text-orange-500 my-1"
                >
                  About Us
          ...
          <div className="lg:w-1/3 md:w-1/2 sm:w-full w-full flex flex-col">
            ...
            <ul className="ml-2">
              <li className="my-2.5">
                <Link
                  to="/"
                  className="relative group text-gray-700 hover:text-orange-500 my-2"
                >
      ...
      <div className="flex flex-wrap justify-between items-center text-sm text-gray-400 gap-2 py-3 border-t border-gray-200 mt-6">
