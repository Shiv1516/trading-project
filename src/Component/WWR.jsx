...
function WWI() {
  return (
    <>
      ...
      <div className="wwi-section flex flex-wrap items-center px-4 md:px-10 lg:px-[14rem] py-30">
        <div className="lg:w-1/2 md:w-full sm:w-full">
        ...
        <div className="lg:w-1/2 md:w-full sm:w-full">
          ...
          <h2 className="text-xl md:text-3xl lg:text-3xl font-semibold mb-7">
            Why Working The Algodelta As Your Trading Software Development
            Company?
          </h2>
          ...
          <div className="flex gap-5 mb-5">
            ...
            <div>
              ...
              <p className="text-gray-300 text-base">
                With over 14 years of experience in the financial field and a
                proven track record of delivering high-quality software
                solutions, ALGODELTA has the expertise to develop trading
